...
RUN pacman -S base base-devel xorg-server xorg-xinit xorg-drivers i3-wm i3-gaps chromium git base binutils neovim curl termite rofi docker docker-compose python python-pip jre-openjdk jdk-openjdk php nodejs npm maven gdb gcc cmake clang valgrind nmap netcat arp-scan zsh openssh sudo noto-fonts feh wireshark-qt irssi tor texlive-most texstudio openvpn bridge-utils easy-rsa discord arandr --noconfirm
...
RUN yay -Sy polybar intellij-idea-ultimate-edition pycharm-professional android-studio android-sdk android-sdk-platform-tools android-sdk-build-tools android-tools chromium-widevine tor-browser typora --noconfirm
