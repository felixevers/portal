...
RUN pacman -S base xorg-server xorg-xinit xorg-drivers i3-wm i3-gaps chromium git neovim curl termite rofi python python-pip jre-openjdk jdk-openjdk php nodejs npm sudo noto-fonts feh arandr --noconfirm
