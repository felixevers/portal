...
RUN pacman -S base base-devel xorg-server xorg-xinit xorg-drivers i3-wm i3-gaps binutils chromium git neovim curl termite rofi sudo noto-fonts feh arandr --noconfirm
